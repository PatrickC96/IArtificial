...
public class Prueba2 {
    ...
    public double empezar() {
        ...
        try {
            ...
            FitnessFunction myFunc = new funcionAptitud2();
...
//            System.out.println("Mejor individuo: ");
        ...
        //System.out.println("valor: "+calularProgrecion(valX));
    ...
    private double calularProgrecion(double valX){
        double x1 = valX-10;
        double x2 = valX;
        double y2 = (3884.7*valX -173594);
        valX = valX - 6;
        double y1 = (3884.7*valX -173594);
        double x=x2+30;
    ...
    public double mostrarIndividuo(IChromosome cromosoma) {
        double valX = new funcionAptitud2().Evaluar(cromosoma);
       System.out.println(valX + " ; resultado: " + (3884.7*valX -173594));
        return valX;
    }
}
